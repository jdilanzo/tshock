...
print('../Figures/lwr_triangular_plot3d.pdf','-dpdf');
figure
LH_plot2D(tscale,xscale,N,K,fd)
fig = gcf; fig.PaperPositionMode = 'auto'; fig_pos = fig.PaperPosition; fig.PaperSize = [fig_pos(3) fig_pos(4)];
print('../Figures/lwr_triangular_plot2d.pdf','-dpdf');
figure
flow2d(tscale,xscale,Q,N,fd)
fig = gcf; fig.PaperPositionMode = 'auto'; fig_pos = fig.PaperPosition; fig.PaperSize = [fig_pos(3) fig_pos(4)];
print('../Figures/lwr_triangular_flow2d.pdf','-dpdf');
figure
smsp2d(tscale,xscale,U,N,fd)
fig = gcf; fig.PaperPositionMode = 'auto'; fig_pos = fig.PaperPosition; fig.PaperSize = [fig_pos(3) fig_pos(4)];
print('../Figures/lwr_triangular_smsp2d.pdf','-dpdf');
